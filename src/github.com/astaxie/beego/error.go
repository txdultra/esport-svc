...
<head>
    ...
    <title>dianjingquan application error</title>
    <style>
...
<body>
    ...
    <div id="footer">
        <p>dianjingquan.cn {{ .BeegoVersion }} (beego framework)</p>
        <p>lang version: {{.GoVersion}}</p>
    </div>
</body>
</html>
`
		...
		<div id="wrapper">
			<div id="container">
				...
				<div id="content">
					...
					<br>Powered by dianjingquan.cn {{.BeegoVersion}}
				</div>
			</div>
		</div>
	</body>
