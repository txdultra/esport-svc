...
func (client *Client) Mdel(keys []string) (int64, error) {
...
func (client *Client) Zadd(key string, value []byte, score int64) (bool, error) {
	res, err := client.sendCommand("ZADD", key, strconv.FormatInt(score, 10), string(value))
	if err != nil {
		return false, err
	}
...
func (client *Client) Zincrby(key string, value []byte, score int64) (int64, error) {
	res, err := client.sendCommand("ZINCRBY", key, strconv.FormatInt(score, 10), string(value))
	if err != nil {
		return 0, err
	}

	data := string(res.([]byte))
	f, _ := strconv.ParseInt(data, 10, 64)
	return f, nil
}
...
func (client *Client) Zrangebyscore(key string, start int64, end int64) ([][]byte, error) {
	res, err := client.sendCommand("ZRANGEBYSCORE", key, strconv.FormatInt(start, 10), strconv.FormatInt(end, 10))
	if err != nil {
		return nil, err
	}
...
func (client *Client) Zrangebyscore2(key string, start int64, end int64, limit int) ([][]byte, error) {
	res, err := client.sendCommand("ZRANGEBYSCORE", key, strconv.FormatInt(start, 10), strconv.FormatInt(end, 10), "LIMIT", strconv.Itoa(limit))
	if err != nil {
		return nil, err
	}
...
func (client *Client) Zrevrangebyscore(key string, start int64, end int64, limit int) ([][]byte, error) {
	res, err := client.sendCommand("ZREVRANGEBYSCORE", key, strconv.FormatInt(start, 10), strconv.FormatInt(end, 10), "LIMIT", strconv.Itoa(limit))
	if err != nil {
		return nil, err
	}
...
func (client *Client) Zcount(key string, min int64, max int64) (int, error) {
	res, err := client.sendCommand("ZCOUNT", key, strconv.FormatInt(min, 10), strconv.FormatInt(max, 10))
	if err != nil {
		return 0, err
	}
...
func (client *Client) Zscore(key string, member []byte) (int64, error) {
...
func (client *Client) Zremrangebyscore(key string, start int64, end int64) (int, error) {
	res, err := client.sendCommand("ZREMRANGEBYSCORE", key, strconv.FormatInt(start, 10), strconv.FormatInt(end, 10))
	if err != nil {
		return -1, err
	}
