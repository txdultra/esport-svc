...
func NewMemcachedCache(hostList []string, defaultExpiration time.Duration, timeout time.Duration) MemcachedCache {
	m := MemcachedCache{memcache.New(hostList...), defaultExpiration}
